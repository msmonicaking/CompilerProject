...
Tok* toksCurr(Toks* toks) {
  if (toksAtEnd(toks)) {
    return tokNew(TOKEOF, NULL, 0, 0, 0);
  } else {
...
// ============================================================================
// Return the next Tok, at toks->tok[1 + toks->tokNum]
// ============================================================================
Tok* toksPeek(Toks* toks) {
  return &toks->tok[1 + toks->tokNum];
}

// ============================================================================
// Return the next-but-1 Tok, at toks->[2 + toks->tokNum]
// ============================================================================
Tok* toksPeek2(Toks* toks) {
  return &toks->tok[2 + toks->tokNum];
}
